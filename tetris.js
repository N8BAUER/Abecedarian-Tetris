...
var linecount = document.getElementById('Score');
...
Piece.prototype.lock = function() {
	for (var ix = 0; ix < this.pattern.length; ix++) {
		for (var iy = 0; iy < this.pattern.length; iy++) {
			...
			if (this.y + iy < 0) {
				// Game ends!
				alert("Failure is an essential component of success!");
				done = true;
				return;
			}
